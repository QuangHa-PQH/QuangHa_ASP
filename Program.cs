...
builder.Services.AddControllers()
    ...
    {
        options.JsonSerializerOptions.ReferenceHandler = null/*System.Text.Json.Serialization.ReferenceHandler.IgnoreCycles*/;
...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Phamquangha_2122110195_1 API", Version = "v1" });
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowReactApp",
        policy => policy.WithOrigins("http://localhost:3000", "http://localhost:3002")
                        .AllowAnyHeader()
                        .AllowAnyMethod()
                        .AllowCredentials());
});
